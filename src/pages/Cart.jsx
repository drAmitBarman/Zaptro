...
const Cart = ({location,getLocation}) => {
  ...
  return (
    <div className='mt-10 max-w-6xl mx-auto md-5 px-4 md:px-0'>
      {
              ...
              <div className='bg-gray-100 rounded-md p-7 mt-4 space-y-2'>
                  ...
                  <div className='flex w-full gap-5'>
                    <div className='flex flex-col space-y-1 w-full'>
                     ...
                     <input placeholder='Enter your state' className='p-2 rounded-md w-full ' value={location.state}/>
                    </div>
                     <div className='flex flex-col space-y-1 w-full'>
                     <label htmlFor="">PostCode</label>
                     <input placeholder='Enter your PostCode' className='p-2 rounded-md w-full ' value={location.postcode}/>
                    </div>
                  </div>
                   <div className='flex w-full gap-5'>
                    <div className='flex flex-col space-y-1 w-full'>
                     <label htmlFor="">Country</label>
                     <input placeholder='Enter your Country' className='p-2 rounded-md w-full ' value={location.country}/>
                    </div>
                     <div className='flex flex-col space-y-1 w-full'>
                     <label htmlFor="">Phone No</label>
                     <input placeholder='Enter your Phone No' className='p-2 rounded-md w-full '/>
                    </div>
                  </div>
              ...
              <div className='bg-white border border-gray-100 shadow-xl rounded-md p-7 mt-4 space-y-2 h-max'>
                ...
                <div>
                  ...
                  <div className='flex gap-3'>
                    <input type="" placeholder='Enter Code' className='p-2 rounded-md w-full'/>
